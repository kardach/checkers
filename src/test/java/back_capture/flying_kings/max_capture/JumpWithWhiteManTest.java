...
public class JumpWithWhiteManTest {
    ...
    private static @NonNull ArrayList<CustomPiecePlacement> getCustomPiecePlacement() {
    ...
    private static @NonNull GameBuilder getGameBuilder() {
        ...
        gameBuilder.setName("""
                ...
                """);
        gameBuilder.setBoard(new Board(3, true, getCustomPiecePlacement()));
    ...
    void backwardJump(Position from, Position to) {
        ...
        assertEquals(Color.WHITE, checkersResource.getGame().getBoard().at(from).getPiece().getColor());
    }
}
